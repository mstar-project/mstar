    ...
    fn put_tensor_batch_columns(
        ...
        for i in 0..n {
            ...
            let info = TensorPointerInfo {
                ...
                // set_shm_placement, exactly as the dict path leaves them.
                offset: 0,
...
mod tests {
    ...
    fn an_untracked_uuid_is_never_collectable() {
        ...
        let b = bk();
        assert!(!b.can_gc(99));
        assert!(!b.ref_info.contains_key(&99));
    ...
    fn mutating_an_untracked_uuid_is_a_no_op_not_an_error() {
        ...
        assert!(!b.ref_info.contains_key(&42));
        assert_eq!(b.len(), 0);
    }
    ...
    fn forget_drops_the_descriptor_with_the_refcount() {
        ...
        b.forget_tensor(1);
        assert!(!b.ref_info.contains_key(&1));
