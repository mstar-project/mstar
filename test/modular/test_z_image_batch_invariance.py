...
4.8e-2; images 39.3 / 30.7 / 37.4 / 33.1 dB after 8 steps, content-independent), so a row in a
batch of four vs alone is reported per stage and per image and asserted only as a gross-error
bound (>= 25 dB).
