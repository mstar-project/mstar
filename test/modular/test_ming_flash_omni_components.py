...
in step 3a of ``mstar/model/ming_flash_omni/PORTING_NOTES.md``.
...
from mstar.model.ming_flash_omni.components.attention import LingAttention
from mstar.model.ming_flash_omni.components.rope import (
    LingPartialMRotaryEmbedding,
)
from mstar.model.ming_flash_omni.components.router import LingMoeRouter
