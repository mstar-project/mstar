...
def _tiny_aggregator(llm_input_dim: int = 16):
    from mstar.model.ming_flash_omni.components.talker_dit import Aggregator
    return Aggregator(
        in_channels=8,
        hidden_size=16,
        depth=2,
...
def test_build_aggregator_llm_input_dim_override() -> None:
    from mstar.model.ming_flash_omni.components.talker_dit import build_aggregator
    cfg = TalkerConfig()
...
def test_build_talker_llm_returns_qwen2_model_with_correct_dims() -> None:
    ...
    from mstar.model.ming_flash_omni.components.talker_dit import build_talker_llm
...
def test_build_talker_heads_emits_stop_head_and_spk_head() -> None:
    ...
    from mstar.model.ming_flash_omni.components.talker_dit import build_talker_heads
