...
def staged_snapshot() -> tuple[str, str]:
    ...
    snap, code_dir = pair
    from mstar.model.ming_flash_omni.ming_flash_omni_model import _prepare_tokenizer_dir
...
def test_vision_encoder_builds_from_config(staged_snapshot: tuple[str, str]) -> None:
    ...
    """
    from mstar.model.ming_flash_omni.components.vision_encoder import build_vision_encoder
    from mstar.model.ming_flash_omni.config import VisionEncoderConfig
...
def test_audio_encoder_constructs_with_defaults() -> None:
    ...
    from mstar.model.ming_flash_omni.components.audio_encoder import MingAudioEncoder
...
def test_audio_encoder_build_from_config() -> None:
    ...
    """
    from mstar.model.ming_flash_omni.components.audio_encoder import build_audio_encoder
    from mstar.model.ming_flash_omni.config import AudioEncoderConfig
...
def test_load_vision_projector_weights_from_snapshot() -> None:
    ...
    from mstar.model.ming_flash_omni.weight_loader import load_vision_projector_weights
...
def test_load_audio_projector_weights_from_snapshot() -> None:
    ...
    from mstar.model.ming_flash_omni.config import MingFlashOmniModelConfig
    from mstar.model.ming_flash_omni.weight_loader import load_audio_projector_weights
...
def test_load_audio_encoder_weights_from_snapshot() -> None:
    ...
    from mstar.model.ming_flash_omni.components.audio_encoder import build_audio_encoder
    from mstar.model.ming_flash_omni.config import MingFlashOmniModelConfig
    from mstar.model.ming_flash_omni.weight_loader import load_audio_encoder_weights
...
def test_load_vision_encoder_weights_from_snapshot(staged_snapshot: tuple[str, str]) -> None:
    ...
    from mstar.model.ming_flash_omni.components.vision_encoder import build_vision_encoder
    from mstar.model.ming_flash_omni.config import MingFlashOmniModelConfig
    from mstar.model.ming_flash_omni.weight_loader import load_vision_encoder_weights
