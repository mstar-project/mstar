...
def test_talker_llm_config_defaults_match_released_ckpt() -> None:
    ...
    from mstar.model.ming_flash_omni.config import TalkerLLMConfig
    llm = TalkerLLMConfig()
...
def test_dit_block_config_intermediate_size_and_head_dim() -> None:
    from mstar.model.ming_flash_omni.config import DiTBlockConfig
    blk = DiTBlockConfig()
...
def test_audio_vae_config_lifts_latent_and_output_dims_from_kwargs() -> None:
    ...
    from mstar.model.ming_flash_omni.config import AudioVAEConfig
...
def test_zimage_dit_config_from_dict_coerces_tuples_and_filters() -> None:
    from mstar.model.ming_flash_omni.config import ZImageDiTConfig
...
def test_image_vae_config_defaults_and_from_dict() -> None:
    from mstar.model.ming_flash_omni.config import ImageVAEConfig
...
def test_imagegen_scheduler_config_from_dict() -> None:
    from mstar.model.ming_flash_omni.config import ImageGenSchedulerConfig
...
def test_byt5_mapper_config_from_nested_json() -> None:
    from mstar.model.ming_flash_omni.config import ByT5MapperConfig
