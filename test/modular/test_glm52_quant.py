"""fp8 block-scale dequant (``quantization.py``): the known-answer and
broadcast cases, ragged tails, the uint8 container view, the paired
weight/scale stream with fp8 passthrough, and the HF config parser.
"""
import sys
