...
Native mminf port of vllm-omni's ``pipeline_ming_imagegen.py`` +
...
class MingImagePipeline:
    ...
    def from_checkpoint(cls, model_path, image_gen_config, *, device="cuda", dtype=torch.bfloat16):
        ...
        from mminf.model.ming_omni_flash.components.condition_encoder import MingConditionEncoder
        from mminf.model.ming_omni_flash.components.zimage_transformer import MingZImageTransformer2DModel
