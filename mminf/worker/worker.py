...
class Worker:
    ...
    def _try_offload_cold_request(
        ...
        if submod_mgmt.cpu_page_pool is None:
            return None
        alloc = submod_mgmt.alloc_manager
        ...
        freed = alloc.offload_request(victim_id, submod_mgmt.cpu_page_pool)
        logger.info(
    ...
    def _try_reload_request(self, node_name: str, request_id: str) -> bool:
        ...
        if not submod_mgmt.cpu_page_pool.is_offloaded(request_id):
            return False
        try:
            submod_mgmt.alloc_manager.reload_request(
                request_id, submod_mgmt.cpu_page_pool
            )
