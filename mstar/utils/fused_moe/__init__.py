...
:func:`fused_experts` covers the bf16 / fp16 path; :func:`fused_experts_fp8`
covers block-scaled FP8 W8A8 (fp8-resident experts, with GLM-5.3-Flash's
opt-in SwiGLU clamp).  If triton is not installed the import fails and
