// Op schemas for the vendored Marlin MoE kernels (vLLM, Apache-2.0), registered under M*'s own
// namespace so they never collide with an installed vLLM.
#include <torch/csrc/stable/library.h>

STABLE_TORCH_LIBRARY(_mstar_marlin_C, m) {
  m.def(
