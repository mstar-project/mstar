...
class MingImagePipeline:
    ...
    def from_checkpoint(cls, model_path, image_gen_config, *, device="cuda", dtype=torch.bfloat16):
        ...
        from mstar.model.ming_flash_omni.components.byte5_encoder import MingByT5Encoder
        from mstar.model.ming_flash_omni.components.condition_encoder import MingConditionEncoder
        from mstar.model.ming_flash_omni.components.zimage_transformer import MingZImageTransformer2DModel
