"""Kimi-K2.7 MLA attention with absorbed and naive fallback paths."""
...
class KimiMLAAttention(nn.Module):
    def __init__(self, config: KimiK2Config, comm_group: CommGroup | None = None) -> None:
        ...
        # run_attention uses 1/sqrt(padded_head_dim); fold DeepSeek's intended
        # qk_head_dim**-0.5 * mscale**2 scale into q on the padded path.
