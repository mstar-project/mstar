...
class FlowUniPCMultistepScheduler(SchedulerMixin, ConfigMixin):
    ...
    # Adapted from diffusers FlowMatchEulerDiscreteScheduler.set_timesteps
    def set_timesteps(
        self,
        ...
        **kwargs,
        ...
        if timestep is not None:
            deprecate(
                "timesteps",
                "1.0.0",
                "Passing `timesteps` is deprecated and has no effect as conversion uses `self.step_index`",
            )
        ...
        **kwargs,
        ...
        if prev_timestep is not None:
            deprecate(
                "prev_timestep",
                "1.0.0",
                "Passing `prev_timestep` is deprecated and has no effect as conversion uses `self.step_index`",
            )
        ...
        **kwargs,
        ...
        if this_timestep is not None:
            deprecate(
                "this_timestep",
                "1.0.0",
                "Passing `this_timestep` is deprecated and has no effect as conversion uses `self.step_index`",
            )
