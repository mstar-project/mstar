...
class KVLayout(Enum):
    NHD = "NHD"
    # One compressed latent per token: no K/V axis and no KV-head axis. What
    # weight-absorbed MLA caches; `head_dim` is the combined ckv + kpe width,
    # and the split point is the attention resource's `mla_ckv_dim`.
    MLA = "MLA"
