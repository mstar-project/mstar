...
class Resource(ABC):
    ...
    def capture_blocked(self) -> str | None:
        """Why a captured replay of this resource would be wrong, or None.

        Read before a runner takes any capture configs, so a node holding such
        a resource declares none and serves eagerly. The string is the log line.
        """
        return None
