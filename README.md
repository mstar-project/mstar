...
Other models: `mstar serve cosmos3` · `mstar serve cosmos3_droid` · `mstar serve qwen3_omni` · `mstar serve qwenvl` · `mstar serve orpheus` · `mstar serve pi05` · `mstar serve vjepa2`
...
| [Qwen3-VL](https://huggingface.co/Qwen/Qwen3-VL-30B-A3B-Instruct) | Vision-language MoE | image, text → text (single-GPU correctness baseline; TP2 not yet accepted; no video) | `/generate` |
